...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/ubuntu/duckietown/catkin_ws/src/arg_nctu/wama/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/ubuntu/duckietown/catkin_ws/devel)
  ...
  set(motion_planning_INSTALL_PREFIX /home/ubuntu/duckietown/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'robotvision <robotvision@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/duckietown/catkin_ws/src/arg_nctu/wama/motion_planning/${idir}'.  Ask the maintainer 'robotvision <robotvision@todo.todo>' to fix it.")
    endif()
