...
if("TRUE" STREQUAL "TRUE")
  set(kinematics_SOURCE_PREFIX /home/ubuntu/duckietown/catkin_ws/src/f4-devel/kinematics)
  set(kinematics_DEVEL_PREFIX /home/ubuntu/duckietown/catkin_ws/devel)
  ...
  set(kinematics_INSTALL_PREFIX /home/ubuntu/duckietown/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dev <dev@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/duckietown/catkin_ws/src/f4-devel/kinematics/${idir}'.  Ask the maintainer 'dev <dev@todo.todo>' to fix it.")
    endif()
...
set(depends "message_runtime;duckietown_msgs;roscpp;rospy")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kinematics_dep}_FOUND)
      find_package(${kinematics_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kinematics_dep} REQUIRED ${depend_list})
  endif()
