...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6f.pack(_x.d_L, _x.d_R, _x.dt, _x.theta_angle_pose_delta, _x.x_axis_pose_delta, _x.y_axis_pose_delta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.d_L, _x.d_R, _x.dt, _x.theta_angle_pose_delta, _x.x_axis_pose_delta, _x.y_axis_pose_delta,) = _struct_6f.unpack(str[start:end])
      return self
