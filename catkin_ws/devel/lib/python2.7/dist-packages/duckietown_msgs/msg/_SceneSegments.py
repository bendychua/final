...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.segimage.header.seq, _x.segimage.header.stamp.secs, _x.segimage.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_2I.pack(_x.segimage.height, _x.segimage.width))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_BI.pack(_x.segimage.is_bigendian, _x.segimage.step))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.segimage.header.seq, _x.segimage.header.stamp.secs, _x.segimage.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.segimage.height, _x.segimage.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.segimage.is_bigendian, _x.segimage.step,) = _struct_BI.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
