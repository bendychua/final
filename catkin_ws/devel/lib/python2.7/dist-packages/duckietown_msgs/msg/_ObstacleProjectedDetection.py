...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3dBf.pack(_x.location.x, _x.location.y, _x.location.z, _x.type.type, _x.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.location.x, _x.location.y, _x.location.z, _x.type.type, _x.distance,) = _struct_3dBf.unpack(str[start:end])
      return self
