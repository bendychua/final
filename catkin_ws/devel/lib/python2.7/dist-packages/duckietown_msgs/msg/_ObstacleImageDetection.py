...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4iB.pack(_x.bounding_box.x, _x.bounding_box.y, _x.bounding_box.w, _x.bounding_box.h, _x.type.type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.bounding_box.x, _x.bounding_box.y, _x.bounding_box.w, _x.bounding_box.h, _x.type.type,) = _struct_4iB.unpack(str[start:end])
      return self
