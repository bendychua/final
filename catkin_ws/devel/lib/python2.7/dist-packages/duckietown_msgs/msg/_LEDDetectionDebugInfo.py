...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Bf.pack(_x.state, _x.capture_progress))
      buff.write(_struct_2I.pack(*self.cell_size))
      buff.write(_struct_4f.pack(*self.crop_rect_norm))
      _x = self
      buff.write(_struct_3I.pack(_x.variance_map.header.seq, _x.variance_map.header.stamp.secs, _x.variance_map.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state, _x.capture_progress,) = _struct_Bf.unpack(str[start:end])
      start = end
      end += 8
      self.cell_size = _struct_2I.unpack(str[start:end])
      start = end
      end += 16
      self.crop_rect_norm = _struct_4f.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      (_x.variance_map.header.seq, _x.variance_map.header.stamp.secs, _x.variance_map.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
