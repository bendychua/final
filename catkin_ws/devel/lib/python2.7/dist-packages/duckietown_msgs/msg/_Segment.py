...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pixels_normalized is None:
        self.pixels_normalized = [duckietown_msgs.msg.Vector2D(),duckietown_msgs.msg.Vector2D()]
      if self.normal is None:
        self.normal = duckietown_msgs.msg.Vector2D()
      if self.points is None:
        self.points = [geometry_msgs.msg.Point(),geometry_msgs.msg.Point()]
    else:
      self.color = 0
      self.pixels_normalized = [duckietown_msgs.msg.Vector2D(),duckietown_msgs.msg.Vector2D()]
      self.normal = duckietown_msgs.msg.Vector2D()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2f.pack(_x.normal.x, _x.normal.y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.normal.x, _x.normal.y,) = _struct_2f.unpack(str[start:end])
      self.points = []
      for i in range(0, 2):
